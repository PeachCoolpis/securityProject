package io.securityproject.security.dsl;
...
public class RestApiDsl<H extends HttpSecurityBuilder<H>> extends
    ...
    public void configure(H http) {
        ...
        getAuthenticationFilter().setSecurityContextRepository(getAuthenticationFilter().getSecurityRepository((HttpSecurity) http));
